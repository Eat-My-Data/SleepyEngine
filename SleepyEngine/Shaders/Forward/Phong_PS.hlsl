...
float4 main(float3 viewFragPos : Position, float3 viewNormal : Normal, float4 sposPL : ShadowPosition, float4 sposSL : ShadowPosition2, float4 sposDL : ShadowPosition3) : SV_Target
{
    float3 diffuse;
    float3 specular;
    ...
    // shadow map test
    const float shadowLevel_spot = 1; //ShadowSL(sposSL, splr);
    ...
    // ========================================================= DIRECTIONAL LIGHT ==================================================
    // shadow map test
    const float shadowLevel_directional = 1; //ShadowDL(sposDL, splr);
	// attenuation
