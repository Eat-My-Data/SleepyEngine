...
void ModelWindow::Show( GraphicsDeviceInterface& gfx, const char* windowName, const Node& root ) noexcept
{
...
dx::XMMATRIX ModelWindow::GetTransform() const noexcept
{
...
const Dcb::Buffer& ModelWindow::GetMaterial() const noexcept
{
	assert( pSelectedNode != nullptr );
