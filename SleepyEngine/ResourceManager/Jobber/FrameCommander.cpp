...
FrameCommander::FrameCommander( GraphicsDeviceInterface& gfx )
	:
...
void FrameCommander::Execute( GraphicsDeviceInterface& gfx ) noexcept
{
...
void FrameCommander::ShowWindows( GraphicsDeviceInterface& gfx )
{
	if ( ImGui::Begin( "Blur" ) )
	{
