...
bool MainController::DoElement( class GraphicsDeviceInterface& gdi, UI_ID& active, UI_ID& hot, Mouse& mouse )
{
...
void MainController::Draw( GraphicsDeviceInterface& gdi )
{
...
void MainController::Interact( SceneManager& sceneManager )
{
	if ( isForwardRender )
	{
...
//bool MainController::Inside( std::pair<u32, u32> mousePos )
//{
