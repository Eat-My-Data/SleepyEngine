#include "DeferredPointLightGeometry.h"
...
DeferredPointLightGeometry::DeferredPointLightGeometry( Graphics& gdi, float radius )
{
...
void DeferredPointLightGeometry::SetPos( DirectX::XMFLOAT3 pos ) noexcept
{
	this->pos = pos;
}

DirectX::XMMATRIX DeferredPointLightGeometry::GetTransformXM() const noexcept
{
