	...
	modelPath( path.string() )
{
	...
	// outline technique
	{
		Technique outline( "Outline", false );
		{
			...
			mask.AddBindable( InputLayout::Resolve( gfx, vtxLayout, *VertexShader::Resolve( gfx, "./Shaders/Bin/Solid_VS.cso" ) ) );
		...
		}
		{
			...
			// TODO: better sub-layout generation tech for future consideration maybe
			draw.AddBindable( InputLayout::Resolve( gfx, vtxLayout,*VertexShader::Resolve( gfx, "./Shaders/Bin/Solid_VS.cso" ) ) );
